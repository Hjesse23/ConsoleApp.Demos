...
var dateOfBirth = new DateTime(2000, 11, 28);
Console.WriteLine($"My Dob is: {dateOfBirth}");

var exactDateAndTimeOfBirth = new DateTime(2000, 11, 28, 17, 16, 25, DateTimeKind.Local);
...
// DateOnly
var dateOnly = new DateOnly(2000, 11, 28);
